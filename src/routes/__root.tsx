...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "RentEaze — Simplifying Rentals in Nigeria" },
      {
        name: "description",
        content:
          "RentEaze makes renting in Nigeria safe, secure and transparent for tenants, landlords and lawyers.",
      },
      { name: "author", content: "RentEaze" },
